		...
		{provided => (
			...
			>
				...
				<div className='ml-auto flex items-center gap-x-2 pr-2'>
						<Pencil className='size-4 coursor-pointer transition hover:opacity-75 cursor-pointer' onClick={onStartEdit} />
						<Trash2 className='size-4 coursor-pointer transition hover:opacity-75 cursor-pointer' onClick={onDelete} />
				</div>
			</div>
		)}
	</Draggable>
